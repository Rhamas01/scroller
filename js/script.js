window.addEventListener('load', function() {
    ...
    class Player {
        ...
        update(input, deltaTime, enemies){
            ...
            enemies.forEach(enemy => {
                const dx = (enemy.x + enemy.width/2)- (this.x + this.width/2-50);
                const dy = (enemy.y + enemy.height/2) - (this.y + this.height/2-50);
    ...
    function handleEnemies(deltaTime) {
       if (enemyTimer > enemyInterval + randomEnemyInterval){
          enemies.push(new Enemy(canvas.width + 100, canvas.height));
    ...
    function displayStatus(context){
       ...
       if (gameOver){
        context.texAlgin = 'center';
        context.fillText('GAME OVER' , canvas.width/2,100);
        context.fillText('Press ENTER to TRY AGAIN', canvas.width/2,150)
       }
    }
